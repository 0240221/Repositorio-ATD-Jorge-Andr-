...
\begin{document}
	\frontmatter
	\maketitle
    	Antes de iniciar con las notas del curso, es importante que se tengan en cuenta las definiciones necesarias de teoría de grupos,
	pues trabajaremos con estas después.
    	\begin{definition}
	...
	\begin{notation}
		...
		al elemento $0_A$ como $0$, a la función $*$ con la suma, y denotaremos $\sum_{i=1}^{n} a = a^n$.
	\end{notation}
